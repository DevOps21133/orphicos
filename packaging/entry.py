"""OrphicOS frozen entry point â€” what the installed OrphicOS.exe runs.
...
_TEMPLATE = """# OrphicOS â€” connection settings
...
_DEFAULT_SERVER_BASE = "https://brain.orphicos.app"
...
def _first_run_setup(cfg_path: Path) -> None:
    ...
    print("Welcome to OrphicOS â€” one-time setup.")
